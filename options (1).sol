...
contract SnowBet {
    ...
    int internal display_price;   

    function get_ETH_USD_PriceData() public
    {
        (
            /* uint80 roundID */,
            int answer,
    ...
    function set_boolean() public view returns (OptionResult[] memory) {
    ...
    function createOption(address _sender, uint8 ticket_type) 
    internal 
    {
